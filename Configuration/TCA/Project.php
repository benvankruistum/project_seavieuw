	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_projectseavieuw_domain_model_project',
				'foreign_table_where' => 'AND tx_projectseavieuw_domain_model_project.pid=###CURRENT_PID### AND tx_projectseavieuw_domain_model_project.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:projectseavieuw/Resources/Private/Language/locallang_db.xml:tx_projectseavieuw_domain_model_project.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
