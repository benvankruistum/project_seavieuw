...
/**
 * Test case for class Tx_Projectseavieuw_Controller_ProjectController.
 *
 * @version $Id$
 ...
 */
class Tx_Projectseavieuw_Controller_ProjectControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
